class Solution {
    void dfsBacktrack(std::vector<std::vector<std::string>>& results ,std::vector<bool>& cols,std::vector<bool>& posDiagonal,std::vector<bool>& negDiagonal,std::vector<std::string>& board, int row, int n) {
